...
export default function EditorToolbar({ editor, onInsertBacklink }: EditorToolbarProps) {
    ...
    const ToolbarButton = ({
        ...
        <button
            ...
            disabled={disabled}
            title={title}
            className={`p-2 rounded hover:bg-surface-muted dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors ${
    ...
    return (
        <div className="border-b dark:border-border bg-background dark:bg-surface-muted p-2 flex flex-wrap items-center gap-1">
            {/* Text Style Group */}
            <ToolbarButton
            ...
            <div className="relative">
                ...
                {showColorPicker && (
                    <div className="absolute top-full left-0 mt-1 p-3 bg-surface border dark:border-border rounded-lg shadow-lg z-50 grid grid-cols-6 gap-2" style={{ minWidth: '200px' }}>
                        {colors.map((color) => (
                            <button
                                key={color}
                                type="button"
                                ...
                                className="w-7 h-7 rounded-md border-2 border-border dark:border-border hover:scale-110 hover:border-gray-400 transition-all"
                        ...
                        <button
                            ...
                            className="col-span-6 mt-2 py-1 text-sm text-gray-600 dark:text-foreground hover:text-gray-900 dark:hover:text-white hover:bg-surface-muted rounded"
                        >
                            Quitar color
                        </button>
                    </div>
            ...
            <div className="relative">
                ...
                {showHighlightPicker && (
                    <div className="absolute top-full left-0 mt-1 p-3 bg-surface border dark:border-border rounded-lg shadow-lg z-50 grid grid-cols-5 gap-2" style={{ minWidth: '180px' }}>
                        ...
                        <button
                            ...
                            className="col-span-5 mt-2 py-1 text-sm text-gray-600 dark:text-foreground hover:text-gray-900 dark:hover:text-white hover:bg-surface-muted rounded"
                        >
                            Quitar resaltado
                        </button>
                    </div>
            ...
            <div className="relative">
                ...
                {showLinkInput && (
                    <div className="absolute top-full left-0 mt-1 p-2 bg-surface border dark:border-border rounded-lg shadow-lg z-50 flex gap-2">
                        <input
                            type="text"
                            value={linkUrl}
                            onChange={(e) => setLinkUrl(e.target.value)}
                            placeholder="https://..."
                            className="px-2 py-1 border dark:border-border rounded text-sm w-48 bg-surface dark:bg-surface-muted text-foreground"
                            onKeyDown={(e) => {
                                if (e.key === 'Enter') {
                                    setLink();
                                }
